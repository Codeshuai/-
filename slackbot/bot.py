...
SCHEDULED_MESSAGES = [
    {'text': 'First message', 'post_at': (
        datetime.now() + timedelta(seconds=20)).timestamp(), 'channel': 'C04NKLZ73K7'},
    {'text': 'Second Message!', 'post_at': (
        datetime.now() + timedelta(seconds=30)).timestamp(), 'channel': 'C04NKLZ73K7'}
]
...
if __name__ == "__main__":
    ...
    ids = list_scheduled_messages('C04NKLZ73K7')
    delete_scheduled_messages(ids, 'C04NKLZ73K7')
